...
if __name__ == '__main__':
    ## The data are saved manually in html format from Factiva database
    ...
    df.to_csv('dow_jones_news_data.csv', encoding="utf-8-sig", index=False)
    djonly.to_csv('only_dow_jones_news_data.csv', encoding="utf-8-sig", index=False)
